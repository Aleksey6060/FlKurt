...
class NotificationService {
  ...
  Future<void> showWelcomeNotification(String userName) async {
    await showNotification(
      ...
      body:
          'Рады видеть вас в Sport Gear. Твой путь к победе начинается здесь!',
    );
  }
  ...
  Future<void> showNewGamesNotification() async {
    await showNotification(
      id: 4,
      title: '🆕 Новое снаряжение!',
      body: 'Проверьте каталог — появились свежие новинки для ваших тренировок.',
    );
  }
}
